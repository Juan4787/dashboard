...
const baseInput = (overrides: Partial<IcsEventInput> = {}): IcsEventInput => ({
	uid: 'appointment-abc123@cita-suite.netlify.app',
	...
	url: 'https://cita-suite.netlify.app/turno/tok123',
	sequence: 0,
	status: 'CONFIRMED',
	method: 'PUBLISH',
...
describe('buildIcs', () => {
	it('genera el evento completo con CRLF y estructura RFC 5545', () => {
		...
		expect(ics).toContain('UID:appointment-abc123@cita-suite.netlify.app\r\n');
