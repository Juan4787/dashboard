-- Fix PL/pgSQL ambiguity introduced by the allowed-email signup flow:
-- output column "business_id" conflicts with unqualified table columns inside
-- SQL statements. Keep the behavior identical, but qualify DML references.
